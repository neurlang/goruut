...
do
	...
	echo '"":[]},' >> ./$LANG/$LANGFILE
	egrep --only-matching '"(SrcMulti|PrePhonWordSteps|DstMultiSuffix|DstMultiPrefix|DropLast|SplitAfter)".+$' ../goruut/dicts/$LANG/$LANGFILE >> ./$LANG/$LANGFILE
